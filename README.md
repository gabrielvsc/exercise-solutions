...
| [727A. Transformation: from A to B](https://github.com/gabrielvsc/exercise-solutions/blob/master/codeforces/451A-GameWithSticks.py) | ⬜ 1000 | `brute force` `dfs` `math` |
| [1491A. K-th Largest Value](https://github.com/gabrielvsc/exercise-solutions/blob/master/codeforces/727A-TrasnformationFromAtoB.py) | ⬜ 800 | `Implementation` `Brute Force` `Greedy` |
